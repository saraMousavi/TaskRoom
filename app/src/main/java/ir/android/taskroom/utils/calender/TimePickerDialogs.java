...
public class TimePickerDialogs extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(TimePickerDialogs view, int hourOfDay, int minute);
    }

    public TimePickerDialogs() {
    ...
    public static TimePickerDialogs newInstance(OnTimeSetListener callback,
                                                int hourOfDay, int minute, boolean is24HourMode) {
        TimePickerDialogs ret = new TimePickerDialogs();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(TimePickerDialogs.this,
