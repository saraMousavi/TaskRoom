...
public class DatePickerDialogs extends DialogFragment implements
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DatePickerDialogs view, int year, int monthOfYear, int dayOfMonth);
    }
     ...
     */
    public static DatePickerDialogs newInstance(OnDateSetListener callBack, int year,
                                                int monthOfYear,
                                                int dayOfMonth) {
        DatePickerDialogs ret = new DatePickerDialogs();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                tryVibrate();
                if (mCallBack != null) {
                    mCallBack.onDateSet(DatePickerDialogs.this, mPersianCalendar.getPersianYear(),
